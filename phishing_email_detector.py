...
# DATE:02/27/2026 
# BRIEF DESCRIPTION: Program for a phishing mail detector.  
...
it was natural for me. I struggled with using the .lower. I was trying to alter the variable in the if statement. but I like the use of 'in' and 'or'.
I understand the logic of the statements its just the syntax. I didn't use AI to write the code but I did use the explain my mistake feature in the autograde details to catch a typo. 
